...
impl PedersenSuite for ThisSuite {
    const BLINDING_BASE: AffinePoint = {
        const X: BaseField =
            MontFp!("15797289012139890952918652741983061499993108868002576830851728385607852258421");
        const Y: BaseField =
            MontFp!("17743238679668623128365684338219902634658870082338213231202641821728201928604"
        );
...
impl crate::ring::RingSuite for ThisSuite {
    ...
    const ACCUMULATOR_BASE: AffinePoint = {
        ...
        const Y: BaseField = MontFp!(
            "6775681885644986793719018988119744802486174723011050942341663377165653894592"
        );
        AffinePoint::new_unchecked(X, Y)
    };
